...
class MyTestCase(unittest.TestCase):
    ...
    def test_correct(self):
        ...
        expected = [{'active': True, 'canonical_url': 'https://www.uga.edu/', 'collection': 12912,
                     ...
                     'last_updated_date': '2020-07-09T16:42:46.987184Z', 'login_password': None,
                     'login_username': None, 'metadata':
                         {'Creator': [{'value': 'University of Georgia', 'id': 5819711}],
                          'Title': [{'value': 'University of Georgia homepage', 'id': 5819713}],
                          'Date': [{'value': 'Captured 2020-', 'id': 5819708}],
                          'Identifier': [{'value': 'https://wayback.archive-it.org/12912/*/https://www.uga.edu/',
                                          'id': 5898372}],
                          'Language': [{'value': 'English', 'id': 5819712}],
                          'Collector': [{'value': 'Hargrett Rare Book & Manuscript Library', 'id': 5819710}],
                          'Rights': [{'value': 'http://rightsstatements.org/vocab/InC/1.0/', 'id': 5819709}]},
