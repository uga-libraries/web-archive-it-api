"""
Tests for the check_fields() shared function.
It returns True or False based on the optional script argument.
"""

import unittest
from shared_functions import check_fields
...
class MyTestCase(unittest.TestCase):
    ...
    def test_arg_is_other(self):
        ...
        """
        actual = check_fields(['C:/path/seed_metadata_report.py', 'other_text'])
    ...
    def test_arg_is_required(self):
        ...
        """
        actual = check_fields(['C:/path/seed_metadata_report.py', 'required'])
    ...
    def test_no_arg(self):
        ...
        """
        actual = check_fields(['C:/path/seed_metadata_report.py'])
