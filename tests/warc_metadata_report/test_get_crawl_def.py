"""
Tests for the get_crawl_def function from the warc_metadata_report.py script.
It returns the crawl definition id for a crawl jub or default text if it can't find one.
"""
import unittest
from warc_metadata_report import get_crawl_def
