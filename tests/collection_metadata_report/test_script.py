...
class MyTestCase(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        """
        os.remove(os.path.join(c.script_output, "collection_metadata.csv"))

    def test_all(self):
        """
        Tests the full script with the optional argument, which creates a report with all fields.
        Result for testing is the spreadsheet created by the script.
        """
        script_path = os.path.join("..", "..", "collection_metadata_report.py")
        subprocess.run(f"python {script_path} all_fields", shell=True)

        report_path = os.path.join(c.script_output, "collection_metadata.csv")
        ...
        expected = [["ID", "Name", "Collector [required]", "Creator", "Date [required]", "Description [required]",
                    ...
                    ["12181", "University of Georgia Student Life", "Hargrett Rare Book & Manuscript Library", "NONE",
                     ...
                     "NONE", "NONE", "NONE", "NONE", "NONE", "University of Georgia Student Life",
                     f"{c.inst_page}/collections/12181/metadata"],
                    ["12249", "Experiments", "University of Georgia Libraries Testing", "NONE", "NONE",
                     "Seeds used for practicing with Archive-It. Not intended for permanent preservation.",
                     "NONE", "NONE", "NONE", "NONE", "NONE", "Experiments",
                     f"{c.inst_page}/collections/12249/metadata"],
                    ["12262", "Political Observers", "Richard B. Russell Library for Political Research and Studies",
                     "NONE", "Captured 2019-", "This collections contains websites created by journalists, "
                                               "academics, and other political observers.",
                     "NONE", "NONE", "NONE", "NONE", "NONE", "Political Observers",
                     f"{c.inst_page}/collections/12262/metadata"],
                    ["12263", "Activists and Advocates",
                     "Richard B. Russell Library for Political Research and Studies", "NONE", "Captured 2019-",
                     ...
                     "NONE", "NONE", "NONE", "NONE", "NONE", "Activists and Advocates",
                     f"{c.inst_page}/collections/12263/metadata"],
                    ["12264", "Georgia Disability History Archive",
                     ...
                     "NONE", "NONE", "NONE", "NONE", "NONE", "Georgia Disability History Archive",
                    ...
                    ["12265", "Georgia Politics", "Richard B. Russell Library for Political Research and Studies",
                     "NONE", "Captured 2019-", "This collection contains websites documenting political activity in "
                                               "the state of Georgia including those created by political candidates, "
                     ...
                     "NONE", "NONE", "NONE", "NONE", "Georgia Politics", f"{c.inst_page}/collections/12265/metadata"],
                    ["12274", "Georgia Newspapers", "The Digital Library of Georgia", "NONE", "NONE",
                     "Test crawls for the Georgia Newspaper Project pilot for collecting born-digital newspapers.",
                     "NONE", "NONE", "NONE", "NONE", "NONE", "Georgia Newspapers",
                     f"{c.inst_page}/collections/12274/metadata"],
                    ["12470", "The Now Explosion", "The Walter J. Brown Media Archives & Peabody Awards Collection",
                     "NONE", "Captured 2020", "Websites related to The Now Explosion television program.", "NONE",
                     "NONE", "NONE", "NONE", "NONE", "The Now Explosion",
                     f"{c.inst_page}/collections/12470/metadata"],
                    ["12907", "University of Georgia Athletics", "Hargrett Rare Book & Manuscript Library",
                     "NONE", "Captured 2019-", "This collection contains websites related to the athletic programs "
                                               "at the University of Georgia.",
                     "NONE", "NONE", "NONE", "NONE", "NONE", "University of Georgia Athletics",
                     f"{c.inst_page}/collections/12907/metadata"],
                    ["12912", "University of Georgia Administration", "Hargrett Rare Book & Manuscript Library",
                     "NONE", "Captured 2019-", "This collection contains websites related to the University of "
                                               "Georgia's administration, including the Office of the President, "
                                               "the Provost, and other leadership roles.",
                     "NONE", "NONE", "NONE", "NONE", "NONE", "University of Georgia Administration",
                     f"{c.inst_page}/collections/12912/metadata"],
                    ["12939", "Business", "Richard B. Russell Library for Political Research and Studies",
                     "NONE", "Captured 2019-", "This collection contains websites documenting business and "
                                               "private enterprise in the state of Georgia.",
                     "NONE", "NONE", "NONE", "NONE", "NONE", "Business", f"{c.inst_page}/collections/12939/metadata"],
                    ["12944", "Legal", "Richard B. Russell Library for Political Research and Studies",
                     "NONE", "Captured 2019-", "This collections contains websites created by attorneys, judges, "
                                               "and organizations working on legal issues in the state of Georgia.",
                     "NONE", "NONE", "NONE", "NONE", "NONE", "Legal", f"{c.inst_page}/collections/12944/metadata"],
                    ["15678", "Georgia Government Publications", "Map and Government Information Library",
                     "NONE", "Captured 2022-", "The University of Georgia Libraries is the official depository for "
                                               "Georgia state publications and, as such, is responsible for their "
                                               "collection, preservation, and accessibility. The Georgia Government "
                                               "Publications Website Archive includes websites of Georgia state "
                                               "agencies and organizations, with an emphasis on those of the executive "
                                               "branch. Select publications included in these websites are also "
                                               "available in the Digital Library of Georgia, Georgia Government "
                                               "Publications collection.",
                     "NONE", "NONE", "NONE", "NONE", "NONE", "Georgia Government Publications Website Archive",
                     f"{c.inst_page}/collections/15678/metadata"],
                    ["16951", "University of Georgia Academics", "Hargrett Rare Book & Manuscript Library",
                     "NONE", "Captured 2021-", "This collection contains websites related research and instruction "
                                               "at the University of Georgia.",
                     "NONE", "NONE", "NONE", "NONE", "NONE", "University of Georgia Academics",
    ...
    def test_required(self):
        """
        Tests the full script without the optional argument, which creates a report with required fields only.
        Result for testing is the spreadsheet created by the script.
        """
        script_path = os.path.join("..", "..", "collection_metadata_report.py")
        ...
        expected = [["ID", "Name", "Collector", "Date", "Description", "Title", "Archive-It Metadata Page"],
                    ...
                    ["12249", "Experiments", "University of Georgia Libraries Testing", "NONE",
                     "Seeds used for practicing with Archive-It. Not intended for permanent preservation.",
                    ...
                    ["12274", "Georgia Newspapers", "The Digital Library of Georgia", "NONE",
                     "Test crawls for the Georgia Newspaper Project pilot for collecting born-digital newspapers.",
